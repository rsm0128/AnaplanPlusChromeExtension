...
var gAutocompleteList = [
  ...
  { name: 'FINDITEM(', type: 'func', label: 'FINDITEM(x, y)', desc: '' },
  { name: 'FIND(', type: 'func', label: 'FIND(x,y,n)', desc: '' },
  { name: 'FIRSTNONBLANK(', type: 'func', label: 'FIRSTNONBLANK', desc: '' },
  { name: 'FIRSTNONZERO(', type: 'func', label: 'FIRSTNONZERO(a, b, c)', desc: '' },
  ...
  { name: 'IRR(', type: 'func', label: 'IRR(Cashflow,0.1)', desc: '' },
  ...
  { name: 'TEXTLIST(', type: 'func', label: 'TEXTLIST(x, y, n, d)', desc: '' },
  { name: 'TIMESUM(', type: 'func', label: 'TIMESUM(x, [f] , [t], [a])', desc: '' },
