...
function applyPalette(configData) {
  ...
  var cssStr = ""  
    ...
    + '.clean .gridrowsummary1, .clean .gridrowsummary1{font-weight:bold; background:' + configData.sum1_cells_color + ';}'
    + '.clean .gridrowsummary2, .clean .gridrowsummary2{font-weight:bold; background:' + configData.sum2_cells_color + ';}'
    + '.clean .gridrowsummary3, .clean .gridrowsummary3{font-weight:bold; background:' + configData.sum3_cells_color + ';}'      
    + '.thin .gridrowsummary1, .thin .gridrowsummary1{font-weight:bold; background:' + configData.sum1_cells_color + ';}'
    + '.thin .gridrowsummary2, .thin .gridrowsummary2{font-weight:bold; background:' + configData.sum2_cells_color + ';}'
    + '.thin .gridrowsummary3, .thin .gridrowsummary3{font-weight:bold; background:' + configData.sum3_cells_color + ';}'            
    //Table Summary Color
    ...
    + '.clean .gridcrosshairs{background: transparent}'
    ...
    + '.thin .gridcrosshairs{background: transparent}'
    //Table Selection
